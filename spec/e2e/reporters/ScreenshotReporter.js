...
var ScreenshotReporter = function (dir_) {
  var dir, index, screenshot, originalAddMatcherResult;

  dir = dir_ || "/tmp/protractorss/";
  index = 0;
  ...
  originalAddMatcherResult = jasmine.Spec.prototype.addMatcherResult;
  jasmine.Spec.prototype.addMatcherResult = function (p) {
    index += 1;
    if (!p) {
